...
////          model.addAttribute("carrito", carritoService.listAll());
////
////        return "redirect:/carrito/add";
////    }
////
//
//    @PostMapping({"/list"})
//    public String listCarrito(@ModelAttribute("articuloCarrito") Articulo articulo, RedirectAttributes attributes) {
//
//        model.addAttribute("carrito", carritoService.listAll());
//
