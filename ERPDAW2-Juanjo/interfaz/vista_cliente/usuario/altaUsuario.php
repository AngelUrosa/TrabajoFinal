...
<h1>Registro de usuario</h1>
	<form name=altaCliente method="POST" action="indexInicialAlumnos.php?principal=interfaz/vista_cliente/usuario/altaUsuario.php">
	...
	<div class="col-12">
    	<button class="btn btn-primary float-right" name="alta"  type="submit">Enviar</button>
  	</div>	
	</form>
