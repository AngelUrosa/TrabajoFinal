...
-->
<form id="formAltaCliente" class="container needs-validation" name="altaCliente" method="POST" action="index.php?principal=interfaz/vista_admni/altaPersona.php" novalidate>
