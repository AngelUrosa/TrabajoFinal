...
if(isset($_POST['buscar'])){
    echo "<h3>Busqueda de pedidos que ha hecho un determinado cliente </h3>";
    $getIdCliente=$_POST['idCliente'];
    $tablaPedidos= $tp->getPedidosPorCliente($idCliente);
}else{
      ...
      $tablaLineasPedidos = $tlp->getLineasUnPedido($p->getIdPedido());
        ...
        echo "<table class='table table-hover'>
            ...
            foreach ($tablaLineasPedidos as $lp) {
                             ...
                             pintarFotoProducto($lp->getIdProducto());
...
function pintarFotoProducto($idProducto){
    $rutaFoto = $trp->getFotoProducto($idProducto);
            echo "<td>". "<img width='40%' src='". getRutaFoto(). "' class='img-thumbnail'></td>";
            echo " </tr>";
}
