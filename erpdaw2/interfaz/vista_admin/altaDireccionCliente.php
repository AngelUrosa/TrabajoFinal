...
<body>
	...
	<form name="altaDireccionCliente" method="POST" action="indexAdminAlumnos.php?principal=interfaz/vista_admin/altaDireccionCliente.php">
	<div class="mx-auto">
...
<button name="alta" value="Guarda" type="submit" class="btn btn-primary">Submit</button>
	...
	<?php 
		...
		if (isset($_POST['alta'])) {
			...
			$insertado=$tDireccionCliente->addDireccionCliente($f);
