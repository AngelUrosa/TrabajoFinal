...
<body>
	...
	<form name="altaEmpleado" method="POST" action="indexAdminAlumnos.php?principal=interfaz/vista_admin/Empleado/altaEmpleado.php">
	<div class="mx-auto">
<div class="mb-31">
...
<div class="mb-31">
  <label for="exampleFormControlInput1" class="form-label">Número móvil</label>
  <input name="movil" type="text" class="form-control" id="movil" placeholder="Número móvil" maxlength="15">
  <div id=nMovil class="form-text" ></div>
</div>
<div class="mb-31">
...
<button name="alta" value="Guarda" type="submit" class="btn btn-primary">Guardar</button>
	...
	<?php 
        ...
        $rutaFoto=$_POST['ruta_foto'];
			...
			//testear que no se repitan nombres de empleados;
			$id=1;//cualquier valor porque lo genera la bd
			$idEmpleado=1;//algoritmo que elabore el idEmpleado
      ...
      $idUsuario=1;//algoritmo que elabore el idUsuario
			...
			$f=new Empleado($id, $idEmpleado, $idDepartamento, $idUsuario, $nombre, $apellido1, $apellido2, $nif, $numCta, $movil, $direcion, $localidad, $codPostal, $provincia, $pais, $rutaFoto, $activo);

			$insertado=$tEmpleado->addUnEmpleado($f);

			if ($insertado) {
				echo "Se ha insertado satisfactoriamente";
			}else{
				echo "Ha habido algun error en la insercion del empleado";
			}
		}
