 ...
 * } elemento 
 */
function caAñadirRegistroAjax(urlTabla, nombre, usuario, url, contraseña, notas, onOk, onError) {
    const parametros = {
        nombre: nombre,
        usuario: usuario,
        url: url,
...
function caAñadirRegistroAjax2(urlTabla, nombre, onOk, onError) {
    const parametros = {
        nombre: nombre,
    };
...
function caEditarRegistroAjax(urlTabla, id, contraseña, notas, onOk, onError) {
    const parametros = {
        id: id,
        contraseña: contraseña,
        notas: notas
